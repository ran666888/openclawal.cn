...
sidebar_position: 1
title: "Architecture"
description: "OpenClaw internals — major subsystems, execution paths, data flow, and where to read next"
---

# 架构

This page is the top-level map of OpenClaw internals. Use it to orient yourself in the codebase, then dive into subsystem-specific docs for implementation details.
...
Exposes OpenClaw as an editor-native agent over stdio/JSON-RPC for VS Code, Zed, and JetBrains.
