...
description: "OpenClaw 如何跨会话记忆 — MEMORY.md、USER.md 和会话搜索"
---

# 持久化记忆

OpenClaw has bounded, curated memory that persists across sessions. This lets it remember your preferences, your projects, your environment, and things it has learned.
...
or update a skill. This is OpenClaw' consent-aware learning loop: repeated
...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, OpenClaw ships with 8 external memory provider plugins — including Honcho, OpenViking, Mem0, Hindsight, Holographic, RetainDB, ByteRover, and Supermemory.
